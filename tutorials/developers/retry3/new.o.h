...
int function_0(struct halide_buffer_t *_b_output_buffer,struct halide_buffer_t *_b2_output_buffer) HALIDE_FUNCTION_ATTRS;
int function_0_old_buffer_t(struct buffer_t *_b_output,struct buffer_t *_b2_output) HALIDE_FUNCTION_ATTRS;
